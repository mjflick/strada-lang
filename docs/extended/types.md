...
### sys::atoi() - String to Integer (C-style)

```strada
my int $n = sys::atoi("123");       # 123
my int $m = sys::atoi("  456");     # 456 (skips whitespace)
my int $x = sys::atoi("abc");       # 0
```

### sys::atof() - String to Float (C-style)

```strada
my num $n = sys::atof("3.14159");   # 3.14159
my num $m = sys::atof("2.5e10");    # 25000000000.0
```
