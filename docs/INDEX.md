...
- String operators: `.` (concat), `eq`, `ne`, `lt`, `gt`
- Control flow: `if/elsif/else`, `while`, `for`, `foreach`
- Built-ins: `say`, `push`, `pop`, `keys`, `values`, `split`, `join`
...
| `CLAUDE_REFERENCE.md` | Comprehensive reference for Claude Code |
| `CLAUDE_DEEP_DIVE.md` | Technical compiler internals |

Archived historical documentation is in `docs/archive/`.

## Version

This documentation covers Strada as of January 2026.
